package com.alurachallenge.DesaFORO.domain.curso;

import com.alurachallenge.DesaFORO.domain.curso.dto.ActualizarCursoDTO;
import com.alurachallenge.DesaFORO.domain.curso.dto.CrearCursoDTO;
...
public class Curso {
    ...
    public Curso(CrearCursoDTO crearCursoDTO) {
        ...
        this.activo = true; // hace que el curso este activo
    }
